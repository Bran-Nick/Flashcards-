...
export default function HomeSummary() {
  ...
  const barColor =
   ...
   return (
    <Link
      to="/progress"
      className="group relative block overflow-hidden rounded-2xl border-2 border-slate-900 bg-slate-900/40 p-4 sm:p-6 transition-all duration-300 hover:-translate-y-1 hover:border-violet-500/50 hover:shadow-[0_12px_30px_rgba(139,92,246,0.15)]"
    >
  ...
  <div className="relative text-center">
    ...
    <div className="absolute right-0 top-1 text-slate-500 transition-colors group-hover:text-violet-400">
  <ArrowRight size={18} />
</div>
  </div>
          ...
          <div className="mt-4 grid grid-cols-3 gap-2 text-center">
            <div>
              <CheckCircle2 className="mx-auto text-emerald-400" size={20} />
            ...
            <div>
              <XCircle className="mx-auto text-rose-400" size={20} />
              <p className="mt-1 text-[10px] font-semibold uppercase tracking-wider text-slate-400">
                Errores
              </p>
        ...
        <div className="hidden md:grid grid-cols-[1fr_1fr_1fr_1.15fr_auto] items-center gap-6">
          ...
          <div className="flex justify-end">
            <div className="flex h-8 w-8 items-center justify-center rounded-full bg-slate-800 text-slate-300 transition-all duration-300 group-hover:bg-violet-600 group-hover:text-white">
              <ArrowRight size={18} />
            </div>
          </div>
        </div>
