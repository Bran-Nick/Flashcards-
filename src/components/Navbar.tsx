  ...
  return (
    <>
      ...
      <header className="sticky top-0 z-[70] w-full border-b border-slate-900 bg-slate-950/80 backdrop-blur-md relative">
        ...
        {isMenuOpen && (
          <nav className="fixed left-0 right-0 top-16 z-[60] md:hidden border-t border-slate-200 dark:border-slate-800 bg-white/95 dark:bg-slate-950/95 px-4 py-3 shadow-xl shadow-slate-300/30 dark:shadow-slate-950/40 backdrop-blur-md">
